...
13. `prompts/02-story-author.md`
14. `games/<caseId>-<slug>/player-config.json`, if continuing an existing setup
...
16. `schemas/validation-report.schema.json`
17. `schemas/runtime-fidelity-report.schema.json`
18. `prompts/03-validator.md`
...
24. `games/<caseId>-<slug>/asset-manifest.json`
...
16. `prompts/04-ai-playtester.md`
...
17. `prompts/05-revision-engine.md`
...
21. `games/<caseId>-<slug>/validation-report.json`, if available
22. `games/<caseId>-<slug>/runtime-fidelity-report*.md`, if available
23. `games/<caseId>-<slug>/runtime-fidelity-report*.json`, if available
24. `games/<caseId>-<slug>/playtest-report.md`, if available
25. Any human feedback or postgame report supplied by the user
...
10. `docs/investigation-model.md`
11. `docs/discovery-rules-v1.md`
12. `docs/npc-interview-model-v1.md`
13. `docs/validator-diagnostics-v1.md`, if reviewing validation or postgame report context
14. `docs/runtime-fidelity-report-v1.md`, if reviewing or producing post-session QA
15. `docs/image-system-v2.md`
16. `docs/case-board-v2.md`
17. `docs/runtime-state-v1.md`
18. `docs/case-board-current-v1.md`
19. `docs/runtime-self-checks.md`
20. `schemas/runtime-state.schema.json`
21. `schemas/case-board-current.schema.json`
22. `schemas/runtime-fidelity-report.schema.json`, if producing post-session QA
23. `prompts/06-game-master.md`
24. `games/index.json`
25. `games/<caseId>-<slug>/gm-readme.md`
26. `games/<caseId>-<slug>/game-package.json`
27. `games/<caseId>-<slug>/case-board-seed.json`
28. `games/<caseId>-<slug>/case-board-current.json`, if resuming active play
29. `games/<caseId>-<slug>/asset-manifest.json`
30. `games/<caseId>-<slug>/validation-report*.md`, if available
31. `games/<caseId>-<slug>/playtest-report.md`, if available
32. `games/<caseId>-<slug>/runtime-fidelity-report*.md`, if available
33. `games/<caseId>-<slug>/runtime-state.json`, if resuming active play
